...
from simplehomeassistant.types.units import AbsoluteHumidityUnit, ApparentPowerUnit, AreaUnit, AtmosphericPressureUnit, \
...
class NumberDeviceClass(BaseNoneDeviceClass):
